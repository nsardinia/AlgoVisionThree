...
// UI specific colors
const invalid = base08, highlightBackground = '#00000008', // Line highlight
background = base00, tooltipBackground = base01, selection = '#DDEEFF', // Selection background
...
const materialLightHighlightStyle = language.HighlightStyle.define([
    ...
    { tag: highlight.tags.keyword, color: base0D, fontWeight: 'bold' },
    { tag: highlight.tags.controlKeyword, color: base0D, fontWeight: 'bold' },
    { tag: highlight.tags.moduleKeyword, color: base0D, fontWeight: 'bold' },
    // Names and variables
    ...
    { tag: [highlight.tags.propertyName], color: base11, fontStyle: 'normal' },
    // Classes and types
    { tag: [highlight.tags.typeName], color: base0C },
    ...
    { tag: [highlight.tags.bracket], color: base0F },
    { tag: [highlight.tags.brace], color: base0F },
    { tag: [highlight.tags.punctuation], color: base03 },
    // Functions and parameters
    { tag: [highlight.tags.function(highlight.tags.variableName)], color: base09 },
    { tag: [highlight.tags.labelName], color: base12, fontStyle: 'italic' },
    { tag: [highlight.tags.definition(highlight.tags.function(highlight.tags.variableName))], color: base09 },
    ...
    { tag: [highlight.tags.atom, highlight.tags.bool], color: base0F },
    // Strings and regex
    { tag: [highlight.tags.processingInstruction, highlight.tags.inserted], color: base10 },
    { tag: highlight.tags.string, color: base10 },
    ...
    { tag: [highlight.tags.definition(highlight.tags.name), highlight.tags.separator], color: base0A },
    ...
    // HTML/XML elements
    { tag: [highlight.tags.tagName], color: base09 },
    { tag: [highlight.tags.attributeName], color: base05 },
    // Markdown and text formatting
    { tag: [highlight.tags.heading], fontWeight: 'bold', color: base11 },
    { tag: highlight.tags.heading1, color: base12 },
    { tag: highlight.tags.heading2, color: base0C },
    { tag: highlight.tags.heading3, color: base0D },
    { tag: highlight.tags.heading4, color: base0E },
    { tag: highlight.tags.heading5, color: base0F },
    { tag: highlight.tags.heading6, color: base10 },
    { tag: [highlight.tags.strong], fontWeight: 'bold', color: base0E },
    { tag: [highlight.tags.emphasis], fontStyle: 'italic', color: base0C },
    // Links and URLs
    {
    ...
    { tag: highlight.tags.squareBracket, color: base08 },
    { tag: highlight.tags.angleBracket, color: base02 },
    // Additional specific styles
    { tag: highlight.tags.monospace, color: base02 },
    { tag: [highlight.tags.contentSeparator], color: base0D },
    { tag: highlight.tags.quote, color: base10 },
]);
/**
...
exports.materialLightMergeStyles = materialLightMergeStyles;
