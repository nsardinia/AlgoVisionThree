...
const gruvboxDarkHighlightStyle = language.HighlightStyle.define([
    ...
    { tag: highlight.tags.keyword, color: base08, fontWeight: 'bold' },
    { tag: highlight.tags.controlKeyword, color: base08, fontWeight: 'bold' },
    { tag: highlight.tags.moduleKeyword, color: base08, fontWeight: 'bold' },
    // Names and variables
    { tag: [highlight.tags.name, highlight.tags.deleted, highlight.tags.character, highlight.tags.macroName], color: base0B },
    { tag: [highlight.tags.variableName], color: base0B },
    { tag: [highlight.tags.propertyName], color: base0D, fontStyle: 'normal' },
    // Classes and types
    { tag: [highlight.tags.typeName], color: base0D },
    { tag: [highlight.tags.className], color: base0A, fontStyle: 'italic' },
    { tag: [highlight.tags.namespace], color: base0B, fontStyle: 'italic' },
    // Operators and punctuation
    { tag: [highlight.tags.operator, highlight.tags.operatorKeyword], color: base07 },
    { tag: [highlight.tags.bracket], color: base05 },
    { tag: [highlight.tags.brace], color: base05 },
    { tag: [highlight.tags.punctuation], color: base05 },
    // Functions and parameters
    { tag: [highlight.tags.function(highlight.tags.variableName), highlight.tags.labelName], color: base0A },
    { tag: [highlight.tags.definition(highlight.tags.variableName)], color: base0B },
    ...
    { tag: [highlight.tags.color, highlight.tags.constant(highlight.tags.name), highlight.tags.standard(highlight.tags.name)], color: base0E },
    { tag: [highlight.tags.atom, highlight.tags.bool, highlight.tags.special(highlight.tags.variableName)], color: base0E },
    // Strings and regex
    { tag: [highlight.tags.processingInstruction, highlight.tags.inserted], color: base09 },
    { tag: [highlight.tags.special(highlight.tags.string), highlight.tags.regexp], color: base09 },
    { tag: highlight.tags.string, color: base09 },
    // Punctuation and structure
    { tag: highlight.tags.definition(highlight.tags.typeName), color: base0D, fontWeight: 'bold' },
    // Comments and documentation
    { tag: highlight.tags.meta, color: base05 },
    { tag: highlight.tags.comment, fontStyle: 'italic', color: base05 },
    { tag: highlight.tags.docComment, fontStyle: 'italic', color: base05 },
    // HTML/XML elements
    ...
    { tag: [highlight.tags.emphasis], fontStyle: 'italic', color: base09 },
    // Links and URLs
    {
    ...
    { tag: highlight.tags.constant(highlight.tags.name), color: base0E },
    { tag: highlight.tags.deleted, color: invalid },
    { tag: highlight.tags.squareBracket, color: base05 },
    { tag: highlight.tags.angleBracket, color: base05 },
    // Additional specific styles
    { tag: highlight.tags.monospace, color: base07 },
    { tag: [highlight.tags.contentSeparator], color: base0B },
    { tag: highlight.tags.quote, color: base05 },
]);
/**
...
exports.gruvboxDarkMergeStyles = gruvboxDarkMergeStyles;
