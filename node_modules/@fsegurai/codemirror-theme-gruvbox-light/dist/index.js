...
const gruvboxLightHighlightStyle = /*@__PURE__*/HighlightStyle.define([
    ...
    { tag: [/*@__PURE__*/tags.function(tags.variableName), tags.labelName], color: base0C },
    { tag: [/*@__PURE__*/tags.definition(tags.variableName)], color: base0D },
    ...
    { tag: [tags.color, /*@__PURE__*/tags.constant(tags.name), /*@__PURE__*/tags.standard(tags.name)], color: base10 },
    { tag: [tags.atom, tags.bool, /*@__PURE__*/tags.special(tags.variableName)], color: base10 },
    // Strings and regex
    { tag: [tags.processingInstruction, tags.inserted], color: base0B },
    { tag: [/*@__PURE__*/tags.special(tags.string), tags.regexp], color: base0B },
    { tag: tags.string, color: base0B },
    // Punctuation and structure
    { tag: /*@__PURE__*/tags.definition(tags.typeName), color: base0F, fontWeight: 'bold' },
    ...
    { tag: /*@__PURE__*/tags.constant(tags.name), color: base10 },
