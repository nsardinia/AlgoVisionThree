...
darkBackground = base07, highlightBackground = base06, tooltipBackground = '#0f1521', // Darker tooltip for better contrast
cursor = base05, selection = base02, selectionForeground = '#ffffff', // Selection text color
...
const abcdefHighlightStyle = /*@__PURE__*/HighlightStyle.define([
    ...
    { tag: tags.namespace, color: '#78a0d3', opacity: 0.8 },
    ...
    { tag: /*@__PURE__*/tags.definition(tags.variableName), color: base0C },
    ...
    { tag: [/*@__PURE__*/tags.special(tags.string), tags.regexp], color: '#6acdbe' /* Turquoise */ },
    // Punctuation and structure
    { tag: /*@__PURE__*/tags.definition(tags.typeName), color: base0E, fontWeight: 'bold' },
    { tag: [tags.operator, tags.operatorKeyword], color: '#ff9cac' },
    { tag: tags.bracket, color: '#d0d6e0' },
    { tag: [tags.brace], color: '#d0d6e0' },
    { tag: tags.punctuation, color: '#d0d6e0' },
    ...
    { tag: tags.string, color: '#7aecb3' /* New mint green for strings */ },
]);
/**
