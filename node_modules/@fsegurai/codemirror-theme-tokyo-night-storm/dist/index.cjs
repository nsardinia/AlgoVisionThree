...
const tokyoNightStormHighlightStyle = language.HighlightStyle.define([
    ...
    // Names and variables
    { tag: [highlight.tags.name, highlight.tags.deleted, highlight.tags.character, highlight.tags.macroName], color: base04 },
    ...
    { tag: [highlight.tags.definition(highlight.tags.variableName)], color: base04 },
    ...
    { tag: [highlight.tags.special(highlight.tags.string), highlight.tags.regexp], color: '#b4f9f8' },
    ...
    { tag: [highlight.tags.definition(highlight.tags.name), highlight.tags.separator], color: base04 },
    ...
    { tag: [highlight.tags.heading], fontWeight: 'bold', color: '#89ddff' },
    { tag: highlight.tags.heading1, color: '#89ddff', fontWeight: 'bold' },
    { tag: highlight.tags.heading2, color: '#89ddff' },
    { tag: highlight.tags.heading3, color: '#89ddff' },
    { tag: highlight.tags.heading4, color: '#89ddff' },
    { tag: highlight.tags.heading5, color: '#89ddff' },
    { tag: highlight.tags.heading6, color: '#89ddff' },
    { tag: [highlight.tags.strong], fontWeight: 'bold', color: base04 },
    ...
    { tag: highlight.tags.monospace, color: base04 },
...
exports.tokyoNightStormMergeStyles = tokyoNightStormMergeStyles;
