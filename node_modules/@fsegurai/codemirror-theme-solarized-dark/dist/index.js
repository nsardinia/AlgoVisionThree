...
const solarizedDarkHighlightStyle = /*@__PURE__*/HighlightStyle.define([
    ...
    { tag: [tags.atom, tags.bool, /*@__PURE__*/tags.special(tags.variableName)], color: base0F },
    // Strings and regex
    { tag: [tags.processingInstruction, tags.inserted], color: base0B },
    { tag: [/*@__PURE__*/tags.special(tags.string), tags.regexp], color: invalid },
    { tag: tags.string, color: base0A },
    // Punctuation and structure
    { tag: /*@__PURE__*/tags.definition(tags.typeName), color: base09, fontWeight: 'bold' },
    { tag: [/*@__PURE__*/tags.definition(tags.name), tags.separator], color: base0C },
