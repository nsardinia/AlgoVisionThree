 ...
 */
const vsCodeDarkTheme = view.EditorView.theme({
    // Base editor styles
    '&': {
        color: base05,
 ...
 */
const vsCodeDarkHighlightStyle = language.HighlightStyle.define([
    ...
    { tag: [highlight.tags.className], color: base0B, fontStyle: 'normal' },
    { tag: [highlight.tags.namespace], color: base05, fontStyle: 'normal' },
    ...
    { tag: [highlight.tags.labelName], color: base0C, fontStyle: 'normal' },
    ...
    { tag: highlight.tags.number, color: base0D },
    { tag: highlight.tags.changed, color: base10 },
    { tag: highlight.tags.annotation, color: base10, fontStyle: 'italic' },
    { tag: highlight.tags.modifier, color: base08, fontStyle: 'normal' },
    ...
    // Strings and regex
    { tag: [highlight.tags.processingInstruction, highlight.tags.inserted], color: base0E },
    { tag: [highlight.tags.special(highlight.tags.string), highlight.tags.regexp], color: '#d16969' },
    ...
    { tag: [highlight.tags.definition(highlight.tags.name), highlight.tags.separator], color: base05 },
    // Comments and documentation
    { tag: highlight.tags.meta, color: base03 },
    { tag: highlight.tags.comment, fontStyle: 'italic', color: base11 },
    { tag: highlight.tags.docComment, fontStyle: 'italic', color: base11 },
    // HTML/XML elements
    ...
    { tag: highlight.tags.heading2, color: base08 },
    { tag: highlight.tags.heading3, color: base08 },
    { tag: highlight.tags.heading4, color: base08 },
    { tag: highlight.tags.heading5, color: base08 },
    { tag: highlight.tags.heading6, color: base08 },
    ...
    { tag: highlight.tags.constant(highlight.tags.name), color: base0A },
    ...
    { tag: highlight.tags.monospace, color: base05 },
    { tag: [highlight.tags.contentSeparator], color: base05 },
    { tag: highlight.tags.quote, color: base11 },
]);
/**
...
const vsCodeDark = [
    vsCodeDarkTheme,
    language.syntaxHighlighting(vsCodeDarkHighlightStyle),
];
/**
...
exports.vsCodeDarkMergeStyles = vsCodeDarkMergeStyles;
