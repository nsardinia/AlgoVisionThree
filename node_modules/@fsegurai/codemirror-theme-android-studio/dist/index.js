...
const androidStudioHighlightStyle = /*@__PURE__*/HighlightStyle.define([
    ...
    { tag: [/*@__PURE__*/tags.function(tags.variableName), tags.labelName], color: base01 },
    { tag: [/*@__PURE__*/tags.definition(tags.variableName)], color: base07 },
    ...
    { tag: [tags.color, /*@__PURE__*/tags.constant(tags.name), /*@__PURE__*/tags.standard(tags.name)], color: base06 },
    { tag: [tags.atom, tags.bool, /*@__PURE__*/tags.special(tags.variableName)], color: base05 },
    // Strings and regex
    ...
    { tag: /*@__PURE__*/tags.constant(tags.name), color: base06 },
