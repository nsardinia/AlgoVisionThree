...
const nordHighlightStyle = language.HighlightStyle.define([
    ...
    { tag: [highlight.tags.variableName], color: base04 },
    ...
    { tag: highlight.tags.number, color: base0B },
    { tag: highlight.tags.changed, color: base0E },
    { tag: highlight.tags.annotation, color: base0A, fontStyle: 'italic' },
    { tag: highlight.tags.modifier, color: base0E, fontStyle: 'italic' },
    { tag: highlight.tags.self, color: base0E },
    { tag: [highlight.tags.color, highlight.tags.constant(highlight.tags.name), highlight.tags.standard(highlight.tags.name)], color: base0B },
    { tag: [highlight.tags.atom, highlight.tags.bool, highlight.tags.special(highlight.tags.variableName)], color: base0E },
    // Strings and regex
    { tag: [highlight.tags.processingInstruction, highlight.tags.inserted], color: base06 },
    { tag: [highlight.tags.special(highlight.tags.string), highlight.tags.regexp], color: base0E },
    { tag: highlight.tags.string, color: base0D },
    // Punctuation and structure
    { tag: highlight.tags.definition(highlight.tags.typeName), color: base0C, fontWeight: 'bold' },
    { tag: [highlight.tags.definition(highlight.tags.name), highlight.tags.separator], color: base0D },
    ...
    { tag: [highlight.tags.strong], fontWeight: 'bold', color: base07 },
    ...
    { tag: [highlight.tags.strikethrough], color: base0A, textDecoration: 'line-through' },
    // Enhanced syntax highlighting
    { tag: highlight.tags.constant(highlight.tags.name), color: base0B },
    { tag: highlight.tags.deleted, color: base0A },
    { tag: highlight.tags.squareBracket, color: base0A },
    { tag: highlight.tags.angleBracket, color: base0B },
    // Additional specific styles
    { tag: highlight.tags.monospace, color: base04, fontStyle: 'italic' },
    { tag: [highlight.tags.contentSeparator], color: base08 },
    { tag: highlight.tags.quote, color: base0E },
]);
/**
...
exports.nord = nord;
exports.nordMergeStyles = nordMergeStyles;
