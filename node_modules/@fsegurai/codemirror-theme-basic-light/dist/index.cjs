...
const basicLightHighlightStyle = language.HighlightStyle.define([
    ...
    // Names and variables
    { tag: [highlight.tags.name, highlight.tags.deleted, highlight.tags.character, highlight.tags.macroName], color: base09 },
    { tag: [highlight.tags.variableName], color: base09 },
    ...
    { tag: [highlight.tags.namespace], color: base09, fontStyle: 'italic' },
    // Operators and punctuation
    { tag: [highlight.tags.operator, highlight.tags.operatorKeyword], color: base0E },
    { tag: [highlight.tags.bracket], color: base07 },
    { tag: [highlight.tags.brace], color: base07 },
    { tag: [highlight.tags.punctuation], color: base07 },
    // Functions and parameters
    { tag: [highlight.tags.function(highlight.tags.variableName), highlight.tags.labelName], color: base08 },
    { tag: [highlight.tags.definition(highlight.tags.variableName)], color: base09 },
    ...
    { tag: [highlight.tags.color, highlight.tags.constant(highlight.tags.name), highlight.tags.standard(highlight.tags.name)], color: base0A },
    { tag: [highlight.tags.atom, highlight.tags.bool, highlight.tags.special(highlight.tags.variableName)], color: base0C },
    // Strings and regex
    { tag: [highlight.tags.processingInstruction, highlight.tags.inserted], color: base07 },
    ...
    { tag: [highlight.tags.attributeName], color: base0D },
    ...
    { tag: highlight.tags.squareBracket, color: base0B },
    { tag: highlight.tags.angleBracket, color: base0C },
    // Additional specific styles
    { tag: highlight.tags.heading1, fontWeight: 'bold', color: base08 },
    { tag: highlight.tags.special(highlight.tags.heading1), fontWeight: 'bold', color: base08 },
    {
        tag: [highlight.tags.heading2, highlight.tags.heading3, highlight.tags.heading4],
        fontWeight: 'bold',
        color: base08,
    },
    { tag: [highlight.tags.heading5, highlight.tags.heading6], color: base08 },
    { tag: highlight.tags.monospace, color: base00 },
    { tag: [highlight.tags.contentSeparator], color: base0D },
    { tag: highlight.tags.quote, color: base01 },
]);
/**
...
exports.basicLightMergeStyles = basicLightMergeStyles;
