 ...
 */
const abyssTheme = view.EditorView.theme({
    // Base editor styles
    '&': {
        color: base01,
 ...
 */
const abyssHighlightStyle = language.HighlightStyle.define([
    // Keywords and control flow
    { tag: highlight.tags.keyword, color: base07, fontWeight: 'bold' },
    { tag: highlight.tags.controlKeyword, color: base0F, fontWeight: 'bold' },
    { tag: highlight.tags.moduleKeyword, color: base07, fontWeight: 'bold' },
    // Names and variables
    { tag: [highlight.tags.name, highlight.tags.deleted, highlight.tags.character, highlight.tags.macroName], color: base08 },
    { tag: [highlight.tags.variableName], color: '#7ab2ff' },
    { tag: [highlight.tags.propertyName], color: base0E, fontStyle: 'normal' },
    // Classes and types
    { tag: [highlight.tags.typeName], color: base03 },
    { tag: [highlight.tags.className], color: base0D, fontStyle: 'italic' },
    { tag: [highlight.tags.namespace], color: base0C, fontStyle: 'italic' },
    ...
    { tag: highlight.tags.annotation, color: base0C, fontStyle: 'italic' },
    ...
    { tag: [highlight.tags.atom, highlight.tags.bool, highlight.tags.special(highlight.tags.variableName)], color: '#ff9e64' },
    // Strings and regex
    ...
    { tag: [highlight.tags.operator, highlight.tags.operatorKeyword], color: '#78b6ff' },
    { tag: [highlight.tags.bracket], color: '#8da0bf' },
    { tag: [highlight.tags.brace], color: '#8da0bf' },
    { tag: [highlight.tags.punctuation], color: '#8da0bf' },
    // Comments and documentation
    { tag: highlight.tags.meta, color: base09 },
    { tag: highlight.tags.comment, fontStyle: 'italic', color: base09 },
    { tag: highlight.tags.docComment, fontStyle: 'italic', color: base09 },
    // HTML/XML elements
    { tag: [highlight.tags.tagName], color: base0F },
    { tag: [highlight.tags.attributeName], color: '#ffd580' },
    // Markdown and text formatting
    { tag: [highlight.tags.heading], fontWeight: 'bold', color: base0E },
    ...
    { tag: highlight.tags.controlKeyword, color: base07, fontWeight: 'bold' },
    { tag: highlight.tags.deleted, color: base08 },
    { tag: highlight.tags.labelName, color: base0B },
...
const abyss = [
    abyssTheme,
    language.syntaxHighlighting(abyssHighlightStyle),
];
/**
...
exports.abyss = abyss;
exports.abyssMergeStyles = abyssMergeStyles;
