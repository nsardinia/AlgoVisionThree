...
const tokyoNightDayHighlightStyle = language.HighlightStyle.define([
    ...
    { tag: highlight.tags.keyword, color: base_cyan, fontWeight: 'bold' },
    { tag: highlight.tags.controlKeyword, color: base_cyan, fontWeight: 'bold' },
    { tag: highlight.tags.moduleKeyword, color: base_cyan, fontWeight: 'bold' },
    // Names and variables
    { tag: [highlight.tags.name, highlight.tags.deleted, highlight.tags.character, highlight.tags.macroName], color: base_blue },
    { tag: [highlight.tags.variableName], color: base01 },
    { tag: [highlight.tags.propertyName], color: base_blue, fontStyle: 'normal' },
    // Classes and types
    { tag: [highlight.tags.typeName], color: base_cyan },
    { tag: [highlight.tags.className], color: base_yellow, fontStyle: 'italic' },
    { tag: [highlight.tags.namespace], color: base_purple, fontStyle: 'italic' },
    // Operators and punctuation
    { tag: [highlight.tags.operator, highlight.tags.operatorKeyword], color: base_purple },
    ...
    { tag: [highlight.tags.function(highlight.tags.variableName)], color: base_cyan },
    { tag: [highlight.tags.labelName], color: base_purple, fontStyle: 'italic' },
    { tag: [highlight.tags.definition(highlight.tags.function(highlight.tags.variableName))], color: base_cyan },
    { tag: [highlight.tags.definition(highlight.tags.variableName)], color: base_blue },
    // Constants and literals
    { tag: highlight.tags.number, color: base_orange },
    { tag: highlight.tags.changed, color: base_orange },
    { tag: highlight.tags.annotation, color: invalid, fontStyle: 'italic' },
    { tag: highlight.tags.modifier, color: base_orange, fontStyle: 'italic' },
    { tag: highlight.tags.self, color: base_orange },
    {
        tag: [highlight.tags.color, highlight.tags.constant(highlight.tags.name), highlight.tags.standard(highlight.tags.name)],
        color: base_orange,
    },
    { tag: [highlight.tags.atom, highlight.tags.bool, highlight.tags.special(highlight.tags.variableName)], color: base_orange },
    // Strings and regex
    { tag: [highlight.tags.processingInstruction, highlight.tags.inserted], color: base_green },
    { tag: [highlight.tags.special(highlight.tags.string), highlight.tags.regexp], color: base_magenta },
    { tag: highlight.tags.string, color: base_green },
    // Punctuation and structure
    { tag: highlight.tags.definition(highlight.tags.typeName), color: base_cyan, fontWeight: 'bold' },
    { tag: [highlight.tags.definition(highlight.tags.name), highlight.tags.separator], color: base_blue },
    ...
    // HTML/XML elements
    { tag: [highlight.tags.tagName], color: base_purple },
    { tag: [highlight.tags.attributeName], color: base_yellow },
    // Markdown and text formatting
    { tag: [highlight.tags.heading], fontWeight: 'bold', color: base_orange },
    { tag: highlight.tags.heading1, color: base_orange, fontWeight: 'bold' },
    { tag: highlight.tags.heading2, color: base_orange },
    { tag: highlight.tags.heading3, color: base_orange },
    { tag: highlight.tags.heading4, color: base_cyan },
    { tag: highlight.tags.heading5, color: base_cyan },
    { tag: highlight.tags.heading6, color: base_cyan },
    ...
    { tag: highlight.tags.constant(highlight.tags.name), color: base_orange },
    ...
    { tag: [highlight.tags.contentSeparator], color: base_blue },
...
exports.tokyoNightDayMergeStyles = tokyoNightDayMergeStyles;
