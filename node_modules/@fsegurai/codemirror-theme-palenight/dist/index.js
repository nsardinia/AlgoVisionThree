...
const palenightHighlightStyle = /*@__PURE__*/HighlightStyle.define([
    ...
    { tag: [/*@__PURE__*/tags.definition(tags.variableName)], color: base08 },
    ...
    { tag: [tags.color, /*@__PURE__*/tags.constant(tags.name), /*@__PURE__*/tags.standard(tags.name)], color: base08 },
    ...
    { tag: [/*@__PURE__*/tags.special(tags.string), tags.regexp], color: base05 },
    { tag: tags.string, color: base05 },
    // Punctuation and structure
    { tag: /*@__PURE__*/tags.definition(tags.typeName), color: base07, fontWeight: 'bold' },
    { tag: [/*@__PURE__*/tags.definition(tags.name), tags.separator], color: base0A },
    ...
    { tag: /*@__PURE__*/tags.constant(tags.name), color: base08 },
    { tag: tags.deleted, color: invalid },
    { tag: tags.squareBracket, color: base0A },
    { tag: tags.angleBracket, color: base0A },
    // Additional specific styles
    { tag: tags.monospace, color: base01 },
    { tag: [tags.contentSeparator], color: base09 },
