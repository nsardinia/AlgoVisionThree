 ...
 */
const palenightTheme = view.EditorView.theme({
    // Base editor styles
    '&': {
        color: base01,
 ...
 */
const palenightHighlightStyle = language.HighlightStyle.define([
    // Keywords and control flow
    { tag: highlight.tags.keyword, color: base06, fontWeight: 'bold' },
    { tag: highlight.tags.controlKeyword, color: base06, fontWeight: 'bold' },
    { tag: highlight.tags.moduleKeyword, color: base06, fontWeight: 'bold' },
    // Names and variables
    ...
    { tag: [highlight.tags.operator, highlight.tags.operatorKeyword], color: base0A },
    { tag: [highlight.tags.bracket], color: base0A },
    { tag: [highlight.tags.brace], color: base0A },
    { tag: [highlight.tags.punctuation], color: base0A },
    ...
    { tag: highlight.tags.self, color: base07 },
    ...
    // Strings and regex
    { tag: [highlight.tags.processingInstruction, highlight.tags.inserted], color: base05 },
    { tag: [highlight.tags.special(highlight.tags.string), highlight.tags.regexp], color: base05 },
    { tag: highlight.tags.string, color: base05 },
    ...
    // HTML/XML elements
    { tag: [highlight.tags.tagName], color: base0B },
    ...
    { tag: highlight.tags.angleBracket, color: base0A },
    // Additional specific styles
    { tag: highlight.tags.monospace, color: base01 },
    { tag: [highlight.tags.contentSeparator], color: base09 },
...
const palenight = [
    palenightTheme,
    language.syntaxHighlighting(palenightHighlightStyle),
];
/**
...
exports.palenight = palenight;
exports.palenightMergeStyles = palenightMergeStyles;
